...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_posts', (
            ...
            ('followup_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='followup_set', null=True, to=orm['blog.Post'])),
        ))
        db.send_create_signal('blog', ['Post'])

        # Adding M2M table for field categories on 'Post'
        m2m_table_name = db.shorten_name('blog_posts_categories')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('blog_posts_categories'))
    ...
    models = {
        ...
        'blog.post': {
            ...
            'followup_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'followup_set'", 'null': 'True', 'to': "orm['blog.Post']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
